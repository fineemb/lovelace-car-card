 ...
 * @LastEditors   : fineemb
 * @LastEditTime  : 2020-10-26 15:01:26
 */
...
`
    ...
    _addMarker(entity,angle){
        ...
        // this.map.setCenter([objstates.attributes.longitude, objstates.attributes.latitude]);
        // return;
    ...
    firstUpdated(changedProperties) {
        ...
        let mapContainer = this.shadowRoot.getElementById("map");
            AMapLoader.load({
                ...
                let objstates = this.hass.states[this.config.entity];
                ...
                let markerContent = `<ha-entity-marker entity-id="`+this.config.entity+`" entity-name="`+entityName+`" entity-picture="`+entityPicture+`"></ha-entity-marker>`;
                // this.marker.setContent(markerContent);
                // this.Cmarker = new AMap.CircleMarker({
                //     map: this.map,
                //     center:[this.hass.config.longitude,this.hass.config.latitude],
                //     strokeWeight:0,
                //     radius:8,
